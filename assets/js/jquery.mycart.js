  ...
  var loadMyCartEvent = function(userOptions){
    ...
    if(!$("#" + idCartModal).length) {
      $('body').append(
        ...
        '<h4 class="modal-title" id="myModalLabel"><span class="fa fa-shopping-cart fa-6x"></span> Meu carrinho</h4>' +
        '</div>' +
        ...
        '<button type="button" class="btn btn-success ' + classCheckoutCart + '">Comprar</button>' +
        '</div>' +
        '</div>' +
        '</div>' +
        '</div>'
    ...
    var drawTable = function(){
      ...
      $.each(products, function(){
        ...
        $cartTable.append(
          ...
          '<td class="text-center" style="width: 30px;"><img width="80px" height="80px" src="' + this.image + '"/></td>' +
          '<td>' + this.name + '</td>' +
