...
function enviar(){
  ...
  <div id='wrapper'>
   <div id='arrow'></div>
	...
	<input type='text' placeholder='Indentidade' id='rg' name='rg' maxlength='15' size='15' required title='Este campo deve apenas conter números' />

	<input type='text' placeholder='CPF'  maxlength='14'size='14' name='cpf' id='cpf' required title='Este campo deve apenas conter números' />

	<input type='text' placeholder='Telefone' maxlength='15' size='15' name='telefone' id='telefone' required pattern="[0-9]+$" title='DDD+numero' />

	<input type='text' placeholder='CEP' maxlength='11' size='11' name='cep' id='cep' required maxlength='11' title='Este campo deve apenas conter números'/>
