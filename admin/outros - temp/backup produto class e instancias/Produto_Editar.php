                        ...
                        <div class="panel-body">
                            <div class="container theme-showcase" role="main">
                                ...
                                <form class="form-horizontal" method="POST" action="Produto_Editar_Processar.php" enctype="multipart/form-data">
                                    ...
                                    <?php 
                                        $idcat = $row_produtos['idcategorias'];
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="nomecat" class="form-control" placeholder="detalhes" value="<?php echo $dados['nomecat']; ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="marca" class="form-control" placeholder="detalhes" value="<?php echo $dados['marca']; ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <img src="./img/<?php echo $row_produtos['img'];?>" width="200px" height="auto" />
                                    ...
                                    <input type="hidden" name="idcategorias" value="<?php echo $row_produtos['idcategorias']; ?>">
