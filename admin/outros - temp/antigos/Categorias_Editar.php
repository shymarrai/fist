                            ...
                            <div class="container theme-showcase" role="main">
                                ...
                                <form class="form-horizontal" method="POST" action="Categorias_Editar_Processar.php" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="nome" class="form-control" placeholder="Nome Completo" value="<?php echo $row_categorias['nome']; ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="textarea" name="descricao" class="form-control" placeholder="" value="<?php echo $row_categorias['descricao']; ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-10">
                                            ...
                                            <a type="button" class="btn btn-info" href="Categorias_Form_Pesquisa_Nome.php">Cancelar</a>
                                        </div>
                                    </div>
                                </form>
