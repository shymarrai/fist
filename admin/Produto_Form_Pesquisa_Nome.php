...
<script>
    $(document).ready(function() {
        ...
        $("#idprodutos").keyup(function() {
            //alert('ok');
            var vidprodutos = $("#idprodutos").val(); //guardando na variavel vnome o valor do id nome
            //alert(vnome);
            //passar o valor do vnome para o arquivo que vai ao banco
            //url, dados, função de retorno
            $.post("Produto_Dados.php", {
                    idprodutos: vidprodutos
                },
                function(saida) {
                    $("#conteudo").html(saida);
                });
                    ...
                    <div class="panel-body">
                        ...
                        <div class=" theme-showcase" role="main">
                            ...
                            <div class="page-header">
                                <center>
                                    <h2>Listar / Pesquisar Produto</h2>
                                </center>
                            </div>
                            <br><br>
                            <div class="container form-group">
                                <form class="form-inline" autocomplete="off">
                                    ...
                                    <input style="width:auto;" type="text" id="idprodutos" class="form-control">
                                </form>
                            </div>
