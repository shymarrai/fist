...
<script>
    $(document).ready(function() {
        ...
        $("#idvenda").keyup(function() {
            //alert('ok');
            var vidvenda = $("#idvenda").val(); //guardando na variavel vnome o valor do id nome
            //alert(vnome);
            //passar o valor do vnome para o arquivo que vai ao banco
            //url, dados, função de retorno
            $.post("Venda_Dados.php", {
                    idvenda: vidvenda
                },
                function(saida) {
                    $("#conteudo").html(saida);
                        ...
                        <div class=" theme-showcase" role="main">
                            ...
                            <div class="container form-group">
                                <form class="form-inline" autocomplete="off">
                                    ...
                                    <input style="width:auto;" type="text" id="idvenda" class="form-control">
                                </form>
                            </div>
