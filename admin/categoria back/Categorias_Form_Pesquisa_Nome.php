                ...
                <div class="content-box-large">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="container theme-showcase" role="main">
                            ...
                            <form class="form-system" method="post" action="Categorias_Pesquisa_Nome.php">

                                <div class="form-group text-center">
                                    <label class="col-sm-2 control-label">Informe o codigo:</label>
                                    <div class="col-sm-4">
                                        <input type="text" name="idcategorias" class="form-control" required>
                                    </div>
